...
Then just move them apart to recreate the image above. If you want to do it more mathematically you need to move in steps of `0.225`. Once you are satisfied with your result, you can delete the reference cube. 
...
Once you downloaded the assetpack drag and drop it into Unity. Unity will ask you if you want to import it and list all the items the assetpack contains. You could pick specific assets you would want to import or go ahead and just import all of them. In most cases you just want to import them all at once.
{{< figure src="/img/UnityAssetImport.jpg" title="Import Dialog" width="100%">}}
Unity will also take over the folder structure of the assetpack.
Once they are imported you can just drag and drop them from the projectview into the hierarchy or directly into the editor and place, rotate and scale them in any way you like.
