...
Design as a Process
Design Process and PseudoCode
Design on Paper an then go deeper
Design and Coding are both Skills, they need practice
Design is an Iterative Process and we will use it for practice
Examples: Ellen Lupton, Dailies, drawABox, Ivan
...
Becaus it is used so much, it is really convenient to get to all the transforms.
